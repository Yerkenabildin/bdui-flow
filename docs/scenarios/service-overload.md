...
**Конфигурация лимитов (адаптивные, условные значения):**

| Тип | Базовый лимит | При перегрузке | Окно |
|-----|---------------|----------------|------|
| Per User (обычный) | 100 req | 50-70 req | 1 min |
| Per User (premium) | 1000 req | 500-700 req | 1 min |
| Per IP | 5000 req | 2500-3500 req | 1 min |
| Per Endpoint | 50000 req | 25000-35000 req | 1 min |

*Числа условные для демонстрации концепции. Реальные лимиты зависят от инфраструктуры.*
