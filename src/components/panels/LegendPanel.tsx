...
const legendItems = [
  ...
  { icon: Gauge, label: 'Rate Limiter', color: '#F97316' },
  { icon: Container, label: 'K8s Cluster', color: '#3B82F6' },
  { icon: Boxes, label: 'Service', color: '#EC4899' },
  { icon: Box, label: 'Pod', color: '#A855F7' },
  { icon: Network, label: 'Sidecar (Envoy)', color: '#06B6D4' },
  { icon: Database, label: 'Cache (Redis)', color: '#EF4444' },
