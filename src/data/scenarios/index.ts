...
3. TTL=30-60 сек — короткий TTL для критичных сервисов (быстрый failover)
...
• Rate limit: 460/1000 (OK)
• Headers: X-RateLimit-Remaining: 540

(Лимиты условные для демонстрации)`,
        duration: 160,
        realLatency: 0.5,
